...
if ( isset($_POST["video"]) ){
		$sql = "INSERT INTO `news_Video`
				(`video`, `title`)
				VALUES 
				('".$_POST["video"]."', '".$_POST["title"]."')
				";
		$result = $dbconnect->query($sql);
}

if ( isset($_GET["delId"]) ){
	$sql = "DELETE FROM `news_Video` WHERE `id` LIKE '".$_GET["delId"]."'";
    $result = $dbconnect->query($sql);
}
?>
<body>
...
<div class="col-md-6">
<div class="form-group">
<label class="control-label mb-10">Youtube Link</label><br>
<input type="text" name="video" class="form-control" multiple>
</div>
</div>
