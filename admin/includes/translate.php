...
if ( !isset($_COOKIE["CREATEkwLANG"]) OR $_COOKIE["CREATEkwLANG"] == "ENG" ){
	...
	$addressText = "Address";
	$deliveryPeriodText  = "Local delivery within 48 hours";/////////////////
	...
	$clientsText = "Clients";
	$addClientsText = "Add Client";
	$aboutText = "About Companies";
	$newsText = "News";
	$titleText = "Title";
	$instructorsText = "Instructors";
	$enNameText = "Name in english";
	$arNameText = "Name in arabic";
	$coursesText = "Courses";
	$lecturesText = "Lectures";
	$invocesText = "Invoices";
	$consultationText = "Consultation";
	$typeText = "Type";
	$dayText = "Day";
	$timeText = "Time";
	$bookingsText = "Bookings";
	$bookInvoicesText = "Book Invoices";
	...
	$bookInvoicesText = "طلبات الكتاب";
    $bookingsText = "الحجوزات";
	$typeText = "النوع";
	$dayText = "اليوم";
	$timeText = "الوقت";
	$consultationText = "الإستشارات";
	$invocesText = "الفواتير";
	$lecturesText = "المحاضرات";
	$coursesText = "المناهج";
	$enNameText = "الإسم بالإنجليزي";
	$arNameText = "الإسم بالعربي";
	$instructorsText = "المدربين";
	$titleText = "العنوان";
	$newsText = "الأخبار";
	$aboutText = "عن الشركات";
	$addClientsText = "أضف عميل";
	$clientsText = "العملاء";
	$copyrightsText = "الحقوق";
	...
	$addressText = "العنوان";
	$deliveryPeriodText  = "التوصيل المحلي خلال 48 ساعة";/////////////////
