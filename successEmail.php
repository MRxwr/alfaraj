<?php
$to = $row["email"];
$subject = 'تأكيد التسجيل في البرنامج التدريبي '.$row["course"];
$headers = 'Content-type: text/html; charset=utf-8' . "\r\n" . 'From: info@alfaraj.co';
$row["startDate"] = explode(" ", $row["startDate"]);
$msg = '
...
<br>
<br>
تم تأكيد تسجيلكم بنجاح في البرنامج التدريبي '.$row["course"].'
<br>
<br>
تبدأ الدورة بتاريخ '.$row["startDate"][0].'
<br>
<br>
